...
# versione 2: usa funzioni logice (and bit a bit e shift) invece della divisione
toBinary:	
...
ciclo:
	...
	andi $t2 $a1 1   # ora t2 vale 0 oppure 1
	addi $t2 $t2 '0' # ora t2 è (il codice ASCII de) la lettera della cifra corrispondete ('0' oppure '1'
	add $t6 $a0 $t0
	sb $t2 ($t6)
	srl $a1 $a1 1     # a1 contiene il rimanente del numero da convertire
